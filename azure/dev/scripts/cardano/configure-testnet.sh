...
docker run -d -h bp.cardano.mylo.farm --name cardano-bp -p 6000:6000 -p 12781:12781 -p 12798:12798 --restart on-failure:3 --security-opt="no-new-privileges=true" \
    ...
    -v /home/groot/cardano/logs:/opt/cardano/cnode/logs -v /home/groot/cardano/config/testnet-topology.json:/opt/cardano/cnode/files/topology.json shibug/cardano-node:1.30.1
...
dki -v $PWD:/keys --entrypoint cardano-cli shibug/cardano-node:1.30.1 stake-address build --stake-verification-key-file /keys/stake.vkey --out-file /keys/stake.addr --testnet-magic 1097911063
dki -v $PWD:/keys --entrypoint cardano-cli shibug/cardano-node:1.30.1 address build --payment-verification-key-file /keys/payment.vkey --stake-verification-key-file /keys/stake.vkey --out-file /keys/payment.addr --testnet-magic 1097911063
